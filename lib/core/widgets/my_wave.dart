...
const Duration _kSplashFadeDuration = Duration(milliseconds: 1000);
...
class WaveSplashFactory extends InteractiveInkFeatureFactory {
  final double strokeWidth;
  final double blurStrength;

  const WaveSplashFactory(this.strokeWidth, this.blurStrength,);
...
class WaveSplash extends InteractiveInkFeature {
  ...
  static InteractiveInkFeatureFactory customSplashFactory({
    ...
    return WaveSplashFactory(strokeWidth, blurStrength,);
  }
